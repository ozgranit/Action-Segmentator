...
from segmentation_metrics import break_seq_wd, precision_recall, precision_recall_chuncks, precision_recall_old
...
if __name__ == '__main__':
    ...
    model = word2vec.Word2Vec(corpus_file=corpus_path, cbow_mean=1, hs=1, sample=1e-5, window=15, vector_size=15)
    ...
    precision, recall, acc, F_score = precision_recall_chuncks(true_sentences, predicted_sentences, len(casas_df))
